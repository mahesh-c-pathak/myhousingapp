...
const MakePayments = () => {
  ...
  const [amount, setAmount] = useState(totalAmount ? parseFloat(formattedtotalAmount) : 0);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.balanceContainer}>
        <View style={styles.balanceItem}>
          ...
          <Text style={styles.balanceValue}>₹ {parseFloat(formattedtotalDue).toFixed(2)}</Text>
        </View>
        <View style={styles.balanceItem}>
          <Text style={styles.balanceTitle}>Current Balance</Text>
          <Text style={styles.balanceValue}>₹ {parseFloat(formattedcurrentBalance).toFixed(2)}</Text>
        </View>
        <View style={styles.balanceItem}>
          <Text style={styles.balanceTitle}>Uncleared Balance</Text>
          <Text style={styles.balanceValue}>₹ {parseFloat(formattedunclearedBalance).toFixed(2)}</Text>
        </View>
      </View>
