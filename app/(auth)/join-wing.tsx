...
const joinWing = () => {
  ...
  const handleFlatPress = (flatId: string, flatType: string, floor: string) => {
    ...
    const handleYesPressed = async (wing: string, floor: string, flat: string) => {
      console.log(
      ...
      try {
        ...
        Alert.alert(
          ...
          [
            {
              text: "OK",
              onPress: () => router.push("/(auth)/startPage"),
            },
          ],
          { cancelable: false }
        );
        ...
        Alert.alert("Error", "Failed to send society joining request. Please try again.");
      } finally {
        setLoading(false);
      }
    };
                  ...
                  {Object.keys(flatsData[selectedWing][floor]).map((flat) => {
                    ...
                    return (
                      <TouchableOpacity
                        ...
                        onPress={() => handleFlatPress(flat, flatData.flatType, floor)}
                      >
          ...
          >
            <View style={styles.modalContainer}>
              <View style={styles.modalContent}>
                {/* Close Icon */}
          <TouchableOpacity style={styles.closeButton} onPress={()=>setUserTypeModalVisible(false)}>
              ...
              <>
                ...
                <View style={styles.modalButtons}>
                  <Pressable
                    style={[styles.button, styles.buttonYes]}
                    onPress={() => {
                      handleYesPressed(selectedWing!, selectedFloor!, selectedFlat!)
                    }}
                  >
