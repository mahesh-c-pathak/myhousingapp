      ...
      >
        ...
        <View
          style={[
            ...
            item.role === "Admin" ? styles.adminBackground : styles.ownerBackground,
            { width: cardWidth },
          ]}
        >
  ...
  return (
    <View style={styles.container}>
      ...
      <Appbar.Header style={styles.header}>
        ...
        <View style={styles.notificationContainer}>
          ...
          <View style={styles.emptyContainer}>
            <Text style={styles.emptyText}>{user.email}</Text>
          </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            <Text style={styles.emptyText}>No societies found. Click on Connect Button to join.</Text>
          </View>
        }
           ...
           >
            ...
            <View>
              ...
              <Text style={styles.connectSubtitle}>
                Create or Join your housing societies/apartment/commercial buildings.
              </Text>
            </View>
          </TouchableOpacity>
        }
