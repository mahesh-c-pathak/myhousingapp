...
import { collection, doc, getDoc, getDocs, query, where, addDoc, updateDoc, collectionGroup } from "firebase/firestore";
  ...
  return (
    <TouchableWithoutFeedback onPress={dismissKeyboard}>
      ...
      <Appbar.Header style={styles.header}>
       ...
       <View style={[styles.content, {marginTop:spacing, marginBottom: spacing }]}>
